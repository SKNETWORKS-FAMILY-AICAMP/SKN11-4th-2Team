  ...
  return (
    <TermsModal title="개인정보처리방침" triggerText="개인정보처리방침">
      ...
      <ol className="list-decimal pl-5 space-y-2">
        ...
        <li>
          <strong>선택항목</strong>: 프로필 이미지, 자녀 정보(생년월일, 성별),
          관심 분야
        </li>
        <li>
          <strong>자동 수집 항목</strong>: IP 주소, 쿠키, 서비스 이용 기록, 접속
          로그, 기기 정보
        </li>
      </ol>
      ...
      <p>
        ...
        경우 회사는 아래와 같이 관계법령에서 정한 일정한 기간 동안 회원정보를
        보관합니다.
      </p>
      <ul className="list-disc pl-5 space-y-2">
        <li>
          <strong>계약 또는 청약철회 등에 관한 기록</strong>: 5년 (전자상거래
          등에서의 소비자보호에 관한 법률)
        </li>
        <li>
      ...
      <ol className="list-decimal pl-5 space-y-2">
        <li>
          ...
          DB에 옮겨져 내부 방침 및 기타 관련 법령에 따라 일정기간 저장된 후 혹은
          즉시 파기됩니다.
        </li>
        <li>
          <strong>파기방법</strong>: 전자적 파일 형태의 정보는 기록을 재생할 수
          없는 기술적 방법을 사용하여 삭제하며, 종이에 출력된 개인정보는
      ...
      <p>
        ...
        처리에 동의하지 않는 경우 동의를 거부하거나 가입해지(회원탈퇴)를 요청할
        수 있습니다. 다만, 그러한 경우 서비스의 일부 또는 전부 이용이 어려울 수
        있습니다.
      </p>
      ...
      <p>
        ...
        운영하는데 이용되는 서버가 이용자의 브라우저에게 보내는 소량의 정보이며
      ...
      <ol className="list-decimal pl-5 space-y-2">
        ...
        <li>
          <strong>해킹 등에 대비한 기술적 대책</strong>: 회사는 해킹이나 컴퓨터
