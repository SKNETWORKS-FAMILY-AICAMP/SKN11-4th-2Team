...
from django.conf import settings  # AUTH_USER_MODEL 사용을 위해
...
class ChatSession(models.Model):
    ...
    websocket_type = models.CharField(max_length=20, default='ai_expert')  # 'ai_expert' 또는 'doc'
...
class ChatMessage(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='생성 시간')
    category = models.CharField(max_length=20, null=True, verbose_name='카테고리')
    is_parenting_related = models.BooleanField(default=True, verbose_name='부모 관련 메시지 여부')
    sources = models.JSONField(null=True, blank=True, verbose_name='문서 검색 결과의 sources 저장')
